...
EGIT_BRANCH=release-2.16
EGIT_COMMIT="d682dd09e36dd60c37070927ace5ab5dcfbd2cd1"

PATCHES=(
	"${FILESDIR}/TileDB-2.15.3-cancel-magic-download.patch"
	"${FILESDIR}/TileDB-2.16.0-cancel-capnp-download.patch"
	"${FILESDIR}/TileDB-2.13.0-cancel-catch-download.patch"
	"${FILESDIR}/TileDB-2.16.0-cancel-webp-download.patch"
)
